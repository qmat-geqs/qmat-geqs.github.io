...
The introduction should give the context of the article and cite relevant scientific references~\cite{wheeler1949electrodynamics,beaudoin2024extending,martin2002historyspinstatistics,landauQuantum} ({\em all} relevant sources are expected to be cited in the text, but not necessarily in the introduction). All sources that appear in the bibliography must be cited in the text.
