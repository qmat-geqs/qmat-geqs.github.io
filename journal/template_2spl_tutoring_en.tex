...
\title{Template for 2SPL tutoring notes}
\thanks{Organised by the ARIANE Tutoring Division at the Faculty of Physics and Engineering, University of Strasbourg.}
...
\begin{abstract}
    Notes for the tutoring session of [April 1, 2026], on the [L1 mathematics, L3 quantum mechanics...] course. Subjects tackled: [matrix multiplication...].
\end{abstract}
...
The tutoring notes can be structured as the author(s) please(s).

\section{Another section}

Images (if there are any) are expected in PDF format, or alternatively in PNG or JPG format.
...
\begin{ruledtabular}
    ...
    \begin{tabular}{ccc}
        ...
        $\widehat{\rm BS}_{\alpha,\beta} (\theta,\varphi)$ & $\exp( \theta ( {\rm e}^{{\rm i}\varphi} b_\alpha b_\beta^\dag - {\rm e}^{-{\rm i}\varphi} b_\alpha^\dag b_\beta) )$ & Beamsplitter \\ \hline
