...
\begin{abstract}
    ...
    \item[Avertissement]
    Ces notes n'ont pas été corrigées par l'enseignant et peuvent contenir des erreurs ou dévier du contenu du cours. L'enseignant ne peut être tenu pour responsable d'éventuelles erreurs ou inexactitudes contenues dans ces notes.
    \end{description}
\end{abstract}
